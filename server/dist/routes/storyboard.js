...
router.get('/projects/:projectId/storyboards', (req, res) => {
    try {
        ...
        const groups = storyboard_1.storyboardModel.getGroups(projectId);
        res.json({
...
router.put('/storyboards/:id', (req, res) => {
    try {
        ...
        const storyboard = storyboard_1.storyboardModel.update(req.params.id, {
...
// 调整分镜顺序
router.post('/projects/:projectId/storyboards/reorder', (req, res) => {
    try {
        ...
        const storyboards = storyboard_1.storyboardModel.updateSequences(projectId, storyboardIds);
        res.json({
            storyboards: storyboards.map(formatStoryboard)
        });
    }
...
// 生成分镜
router.post('/projects/:projectId/storyboards/generate', (req, res) => {
    try {
        const projectId = req.params.projectId;
